...
class proftpd::params {
  ...
  $sql_whereclause       = '1'
  $sql_authtypes         = 'Crypt Backend Plaintext'
  $sql_userinfo          = 'users userid passwd uid gid homedir shell'
  $sql_groupinfo         = 'groups groupname gid members'
  $sql_authenticate      = 'users usersetfast'
  $sql_requirevalidshell = 'off'
  $sql_defaultuid        = '65533'
  $sql_defaultgid        = '65533'
