...
class proftpd::config(
  ...
  $sql_whereclause       = $proftpd::params::sql_whereclause,
  $sql_authtypes         = $proftpd::params::sql_authtypes,
  $sql_userinfo          = $proftpd::params::sql_userinfo,
  $sql_groupinfo         = $proftpd::params::sql_groupinfo,
  $sql_requirevalidshell = $proftpd::params::sql_requirevalidshell,
  $sql_authenticate      = $proftpd::params::sql_authenticate,
  $sql_defaultuid        = $proftpd::params::sql_defaultuid,
  $sql_defaultgid        = $proftpd::params::sql_defaultgid,
